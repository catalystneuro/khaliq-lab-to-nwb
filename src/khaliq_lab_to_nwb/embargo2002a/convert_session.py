...
from .embargo2002a import Embargo2002ANWBConverter
...
def session_to_nwb(data_dir_path: Union[str, Path], output_dir_path: Union[str, Path], stub_test: bool = False):
    ...
    converter = Embargo2002ANWBConverter(source_data=source_data)
    ...
    editable_metadata_path = Path(__file__).parent / "embargo2002a_metadata.yaml"
...
<<<<<<< HEAD:khaliq-lab-to-nwb/src/khaliq_lab_to_nwb/embargo2002a/convert_session.py
...
>>>>>>> main:khaliq-lab-to-nwb/src/khaliq_lab_to_nwb/embargo2002a/embargo2002a_convert_session.py
